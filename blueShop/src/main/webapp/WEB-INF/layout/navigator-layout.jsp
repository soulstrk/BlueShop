...
<nav class="navbar navbar-expand-lg navbar-white" style="height: 110px;">
	...
	<div class="collapse navbar-collapse" id="navbarColor02">
		<ul class="navbar-nav" style="margin-left: 13em; height: 7em;">
			...
			<li class="nav-item active"><a class="nav-link active" href="main/join.do"><b>Join</b></a></li>
			...
			<img src="${pageContext.request.contextPath }/resources/images/hd_logo.png"
					style="width: 223px; height: 45px; position: relative; left: 17em; padding-bottom: 0px;">
			<li class="nav-item active" id="myPage"><a class="nav-link" href="#"><b>My page</b></a></li>
			<li class="nav-item active">
				<form class="form-inline my-2 my-lg-2" id="searchForm" style="position: relative; left: 38em;" method="post" action="search.do?pageNum=1">
